            ...
            <div class="card">
              ...
              <div class="card-body">
                <form class="row g-3 needs-validation custom-input" novalidate
                      action="{{ route('admin.manage-privacy-policy.store') }}"
                  ...
                  <div class="col-12">
                    <div class="form-group">
                      ...
                      <textarea name="privacy_policy" class="form-control editor" rows="5"></textarea>
                    </div>
                  </div>
                  ...
                  <div class="col-12">
                    <div class="form-group">
                      ...
                      <textarea name="contact_details" class="form-control editor" rows="5"></textarea>
                    </div>
                  </div>
  ...
  (function () {
    ...
    function addQaRow() {
      ...
      tr.innerHTML =
        ...
        '<td><input type="text" name="questions[' + i + '][question]" class="form-control" placeholder="Enter question" required></td>' +
        '<td><textarea id="' + key + '" data-editor-key="' + key + '" name="questions[' + i + '][answer]" class="form-control" rows="3"></textarea></td>' +
    ...
    document.getElementById('addQaRow').addEventListener('click', addQaRow);
