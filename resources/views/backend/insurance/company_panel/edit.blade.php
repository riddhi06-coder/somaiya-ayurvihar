        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Edit Insurance Company Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" 
                                          action="{{ route('admin.manage-company-panel.update', $insurance->id) }}" 
                                        ...
                                        <div class="col-md-6 mt-5">
                                            ...
                                            <input class="form-control" id="insurance_type" type="text" name="insurance_type"  value="{{ $insurance->insurance_type }}"  placeholder="Enter Insurance Type" required>
