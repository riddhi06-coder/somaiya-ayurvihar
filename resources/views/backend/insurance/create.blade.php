            ...
            <div class="page-title">
              <div class="row">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Add Insurance & TPA</li>
                </ol>
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('admin.manage-insurance.store') }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="insurance_heading" type="text" name="insurance_heading" placeholder="Enter Heading" required>
                                        ...
                                        <div class="col-md-6 mt-5">
                                            ...
                                            <input class="form-control" id="essential_heading" type="text" name="essential_heading" placeholder="Enter Heading" required>
                                            <div class="invalid-feedback">Please enter a Heading.</div>
                                        </div>
                                       ...
                                       <!--  Image -->
                                        <div class="col-md-6 mt-5">
                                            ...
                                            <input class="form-control" id="essential_image" type="file" name="essential_image" onchange="previewdocimage(event)" required>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" id="essential_desc" name="essential_desc" placeholder="Enter Description" required></textarea>
                                            <div class="invalid-feedback">Please enter an Description.</div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="cashless_heading" type="text" name="cashless_heading" placeholder="Enter Heading" required>
                                            <div class="invalid-feedback">Please enter a Heading.</div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" id="cash_desc" name="cash_desc" placeholder="Enter Description" required></textarea>
                                            <div class="invalid-feedback">Please enter an Description.</div>
                                        </div>
                                            ...
                                            <table class="table table-bordered mt-5" id="pageHeadersTable">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <!-- Heading -->
                                                        <td>
                                                            <input type="text" name="cashless_details[0][heading]" 
                                                                   class="form-control" placeholder="Enter Heading">
                                                        </td>
                                        
                                                        <!-- Description -->
                                                        <td>
                                                            <textarea name="cashless_details[0][time]" 
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" id="short_cash_desc" name="short_cash_desc" placeholder="Enter Short Description" required></textarea>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" id="tpa_desc" name="tpa_desc" placeholder="Enter Description" required></textarea>
                                            <div class="invalid-feedback">Please enter an Description.</div>
                                        </div>
                                       ...
                                       <!--  Image -->
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" id="reimburse_desc" name="reimburse_desc" placeholder="Enter Description" required></textarea>
                                            <div class="invalid-feedback">Please enter an Description.</div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" id="disclaimer_desc" name="disclaimer_desc" placeholder="Enter Disclaimer" required></textarea>
