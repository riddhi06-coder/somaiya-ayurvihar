                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('admin.manage-testimonials.store') }}" method="POST" enctype="multipart/form-data" id="testimonialForm">
                                        @csrf
                                        ...
                                        <!-- Title (shown + required only for video) -->
                                        ...
                                        <div class="col-md-12 mt-4 text-fields">
                                            ...
                                            <textarea class="form-control" id="editor" name="testimonial" rows="4" placeholder="Enter the testimonial"></textarea>
                                        ...
                                        <div class="col-md-4 mt-4 text-fields">
                                            ...
                                            <input class="form-control" id="person_name" type="text" name="person_name" placeholder="Enter Name">
                                        ...
                                        <div class="col-md-6 mt-4 video-fields d-none">
                                            ...
                                            <small class="text-secondary"><b>Note: Only .jpg, .jpeg, .png, .webp allowed. Max 2MB.</b></small>
                                        ...
                                        <!-- Video (video only) -->
                                        <div class="col-md-6 mt-4 video-fields d-none">
                                            <label class="form-label" for="video">Testimonial Video <span class="txt-danger">*</span></label>
