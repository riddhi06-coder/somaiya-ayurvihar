                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate 
                                          action="{{ route('admin.manage-csr-sustainability.update', $sustainability->id) }}" 
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" id="editor" name="desc" placeholder="Enter Introduction" required>{{ old('desc', $sustainability->desc) }}</textarea>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="uhtc_heading" type="text"  value="{{ old('uhtc_heading', $sustainability->uhtc_heading) }}" name="uhtc_heading" placeholder="Enter Heading" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            @if($sustainability->uhtc_image)
                                                <div class="mt-2">
                                                    <img src="{{ asset('uploads/csr/'.$sustainability->uhtc_image) }}"
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" id="uhtc_desc" name="uhtc_desc" placeholder="Enter Description" required>{{ old('uhtc_desc', $sustainability->uhtc_desc) }}</textarea>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="support_heading" type="text" value="{{ old('support_heading', $sustainability->support_heading) }}" name="support_heading" placeholder="Enter Heading" required>
                                            <div class="invalid-feedback">Please enter a  Heading.</div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            @if($sustainability->support_image)
                                                <div class="mt-2">
                                                    <img src="{{ asset('uploads/csr/'.$sustainability->support_image) }}"
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" id="support_desc" name="support_desc" placeholder="Enter Description" required>{{ old('support_desc', $sustainability->support_desc) }}</textarea>
                                            <div class="invalid-feedback">Please enter an Description.</div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="community_heading" type="text" value="{{ old('community_heading', $sustainability->community_heading) }}" name="community_heading" placeholder="Enter Heading" required>
                                            <div class="invalid-feedback">Please enter a  Heading.</div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            @if($sustainability->community_image)
                                                <div class="mt-2">
                                                    <img src="{{ asset('uploads/csr/'.$sustainability->community_image) }}"
                                                         style="max-height:150px;">
                                                </div>
                                            @endif
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" id="community_desc" name="community_desc" placeholder="Enter Description" required>{{ old('community_desc', $sustainability->community_desc) }}</textarea>
                                            <div class="invalid-feedback">Please enter an Description.</div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" id="donation_desc" name="donation_desc" placeholder="Enter Blood Donation Description" required>{{ old('donation_desc', $sustainability->donation_desc) }}</textarea>
                                        ...
                                        <div class="col-md-12 mt-5">
                                            ...
                                            <textarea class="form-control" id="inclusive_desc" name="inclusive_desc" placeholder="Enter Inclusive Care Description" required>{{ old('inclusive_desc', $sustainability->inclusive_desc) }}</textarea>
                                        ...
                                        <table class="table table-bordered mt-2" id="galleryTable">
                                            <thead>
                                                <tr>
