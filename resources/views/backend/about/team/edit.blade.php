        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Edit Management Team Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit Management Team</li>
                </ol>
                                ...
                                <div class="tab-content" id="wizard-tabContent">
                                    <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                        <form class="row g-3 needs-validation custom-input"
                                            novalidate
                                            action="{{ route('admin.manage-management-team.update',$team->id) }}"
                                            method="POST"
                                            ...
                                            <div class="col-md-6 mt-5">
                                                ...
                                                <small class="text-secondary"><b>Allowed: jpg, jpeg, png, webp, svg (Max 2MB)</b></small>
                                            ...
                                            <div class="col-12 text-end mt-4">
                                                <a href="{{ route('admin.manage-management-team.index') }}" class="btn btn-danger px-4">
                                                    Cancel
                                                </a>
