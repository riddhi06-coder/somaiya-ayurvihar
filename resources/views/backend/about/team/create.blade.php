        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Add Management Team Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                    <a href="{{ route('admin.manage-management-team.index') }}">Home</a>
                    </li>
                    <li class="breadcrumb-item active">Add Management Team</li>
                </ol>
                            ...
                            <div class="col-12">
                                <div class="tab-content" id="wizard-tabContent">
                                    <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                        <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('admin.manage-management-team.store') }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="col-md-6 mt-5">
                                                ...
                                                <input class="form-control" id="designation" type="text" name="designation" placeholder="Enter Designation" required>
                                            ...
                                            <div class="col-12 text-end">
                                                <a href="{{ route('admin.manage-management-team.index') }}" class="btn btn-danger px-4">Cancel</a>
