                    ...
                    <div class="col-6">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">
                                <a href="{{ route('admin.manage-prayer.index') }}">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb mb-0">
                                        <li class="breadcrumb-item"><a href="{{ route('admin.manage-prayer.index') }}">Home</a></li>
                                        <li class="breadcrumb-item active">Somaiya Prayer</li>
                                    </ol>
                                </nav>
                                <a href="{{ route('admin.manage-prayer.create') }}" class="btn btn-primary px-5 radius-30">
                                    + Add Somaiya Prayer
                                </a>
                            </div>
