        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Edit Somaiya Prayer Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit Somaiya Prayer</li>
                </ol>
                                ...
                                <div class="tab-content" id="wizard-tabContent">
                                    <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                        <form class="row g-3 needs-validation custom-input" novalidate 
                                            action="{{ route('admin.manage-prayer.update', $prayer->id) }}" 
                                            method="POST" 
                                            ...
                                            <div class="col-md-6 mt-5">
                                                ...
                                                <input class="form-control" 
                                                    ...
                                                    type="text" 
                                                    name="heading" 
                                                    value="{{ old('heading', $prayer->heading) }}" 
                                            ...
                                            <div class="col-md-6 mt-5">
                                                ...
                                                @if($prayer->image)
                                                    <div class="mt-3">
                                                        <p>Current Image:</p>
                                                        <img src="{{ asset('uploads/prayer/'.$prayer->image) }}" alt="Prayer Image" width="150">
                                                    </div>
                                                @endif
                                            ...
                                            <div class="col-12">
                                                ...
                                                <textarea name="description" 
                                                        ...
                                                        class="form-control" 
                                                        rows="5" 
                                                        required>{{ old('description', $prayer->description) }}</textarea>
                                            </div>
