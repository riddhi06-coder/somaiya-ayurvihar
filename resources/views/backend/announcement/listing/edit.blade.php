                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate  action="{{ route('admin.manage-announcements.update', $announcements->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="col-md-6 mt-5">
                                            ...
                                            <input class="form-control" id="title" type="text" name="title" placeholder="Enter Title" value="{{ $announcements->title }}" required>
                                        ...
                                        <div class="col-md-6 mt-5">
                                            ...
                                            <input class="form-control" id="date" type="date" name="date" value="{{ $announcements->date }}" required>
                                        ...
                                        <div class="col-md-6 mt-5">
                                            ...
                                            <input class="form-control" id="announce_image" type="file" name="announce_image" onchange="previewimage(event)">
                                            ...
                                            <div class="mt-2">
                                                @if($announcements->image)
                                                    <img src="{{ asset('public/uploads/announcements/'.$announcements->image) }}" 
