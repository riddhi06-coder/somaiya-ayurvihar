        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Add Convenience & Facilities Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Add Convenience & Facilities</li>
                </ol>
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('admin.manage-convenience-facilities.store') }}" method="POST" enctype="multipart/form-data">
                                            @csrf

                                        <!-- Description-->
                                        <div class="col-md-12">
                                            <label class="form-label" for="cafeteria_intro_desc"> Description<span class="txt-danger">*</span></label>
                                            <textarea class="form-control" id="editor" name="cafeteria_intro_desc" placeholder="Enter Description" required></textarea>
                                        ...
                                        <div class="col-md-6 mt-5">
                                            ...
                                            <input class="form-control" id="cafeteria_heading" type="text" name="cafeteria_heading" placeholder="Enter Heading" required>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" id="cafeteria_desc" name="cafeteria_desc" placeholder="Enter Description" required></textarea>
                                            <div class="invalid-feedback">Please enter an Description.</div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="atm_heading" type="text" name="atm_heading" placeholder="Enter Heading" required>
                                            <div class="invalid-feedback">Please enter a Heading.</div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" id="atm_desc" name="atm_desc" placeholder="Enter Description" required></textarea>
                                            <div class="invalid-feedback">Please enter an Description.</div>
                                        </div>
                                       ...
                                       <div class="col-12">
                                                ...
                                                <table class="table table-bordered" id="atmTable">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <!-- Details -->
                                                            <td>
                                                                <textarea name="atm_details[0][details]"
                                                                          class="form-control"
                                                                          rows="3"
                                        ...
                                        <div class="col-md-12 mt-5">
                                            ...
                                            <textarea class="form-control" id="short_atm_desc" name="short_atm_desc" placeholder="Enter Short Description" required></textarea>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="pharmacy_heading" type="text" name="pharmacy_heading" placeholder="Enter Heading" required>
                                            <div class="invalid-feedback">Please enter a Heading.</div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" id="pharmacy_desc" name="pharmacy_desc" placeholder="Enter Description" required></textarea>
                                            <div class="invalid-feedback">Please enter an Description.</div>
                                        </div>
                                                ...
                                                <table class="table table-bordered" id="pharmacyTable">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text"
                                                                       name="pharmacy_details[0][title]"
                                                                       class="form-control"
                                                                       placeholder="Enter Title">
                                                            </td>
                                        
                                                            <td>
                                                                <textarea name="pharmacy_details[0][details]"
                                                                          class="form-control"
                                                                          rows="3"
                                                                          placeholder="Enter Details"></textarea>
                                                            </td>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="internet_heading" type="text" name="internet_heading" placeholder="Enter Heading" required>
                                            <div class="invalid-feedback">Please enter a Heading.</div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" id="internet_desc" name="internet_desc" placeholder="Enter Description" required></textarea>
                                            <div class="invalid-feedback">Please enter an Description.</div>
                                        </div>
