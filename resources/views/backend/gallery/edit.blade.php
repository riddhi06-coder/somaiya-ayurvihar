        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Edit Gallery Listing Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit Gallery Listing</li>
                </ol>
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" 
                                        novalidate 
                                        action="{{ route('admin.manage-gallery.update', $gallery->id) }}" 
                                        method="POST" 
                                        ...
                                        <div class="col-md-6 mt-5">
                                            ...
                                            <input class="form-control" id="event_name" type="text" name="event_name" value="{{ old('event_name', $gallery->event_name) }}" placeholder="Enter Event Name" required>
                                        ...
                                        <div class="col-md-6 mt-5">
                                            ...
                                            @if($gallery->image)
                                                <div class="mt-3">
                                                    ...
                                                    <img src="{{ asset($gallery->image) }}" width="120" height="120" style="object-fit: cover; border:1px solid #ddd;">
                                                </div>
                                            @endif
                                       ...
                                       <!-- Date -->
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" class="form-control" id="date" name="date"   value="{{ old('date', $gallery->date) }}">
