                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('admin.manage-biomedical-waste.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="col-md-6 mt-5">
                                            ...
                                            <input class="form-control" id="doc_name" type="text" name="doc_name" placeholder="Enter Document Name" required>
                                        ...
                                        <div class="col-md-6 mt-5">
                                            <div class="form-group">
                                                <label>Upload Document (PDF / Word) <span class="txt-danger">*</span></label>
                                                <input type="file" name="document" accept=".pdf,.doc,.docx" onchange="previewDoc(this)" class="form-control">
