                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input"
                                        novalidate
                                        action="{{ route('admin.manage-contact-us.update', $contact->id) }}"
                                        method="POST"
                                        ...
                                        <div class="col-md-6 mt-5">
                                            ...
                                            <input class="form-control" id="emergency_heading" type="text" name="emergency_heading" value="{{ old('emergency_heading',$contact->emergency_heading) }}" placeholder="Enter Emergency Heading" required>
                                        ...
                                        <div class="table-responsive mt-5">
                                            <table class="table table-bordered" id="emergencyTable">
                                                ...
                                                <tbody id="tableBody">
                                                    ...
                                                    @if(!empty($contact->emergency_details))
                                                        @foreach($contact->emergency_details as $key => $emergency)

                                                    <tr>
                                                        <td>
                                                            <input type="text" name="center_name[]" class="form-control"
                                                            value="{{ $emergency['center_name'] ?? '' }}"
                                        ...
                                        <div class="col-md-6 mt-5">
                                            ...
                                            <input class="form-control" id="hospital_name" type="text" name="hospital_name" value="{{ old('hospital_name',$contact->hospital_name) }}" placeholder="Enter Hospital Name" required>
                                        ...
                                        <div class="col-md-6 mt-5">
                                            ...
                                            <input type="text" name="call_us" id="call_us" class="form-control" 
                                                placeholder="+91 22 6112 4800, +91 22 5095 4700" value="{{ old('call_us',$contact->call_us) }}" 
                                        ...
                                        <div class="col-md-6 mt-5">
                                            ...
                                            <textarea name="location" id="location" class="form-control" rows="2"
                                                placeholder="Enter Location" required>{{ old('location',$contact->location) }}</textarea>
                                        </div>
                                        ...
                                        <div class="col-md-6 mt-5">
                                            ...
                                            <input type="url" name="location_url" id="location_url" class="form-control" rows="2"
                                                placeholder="Enter URL" value="{{ old('location_url',$contact->location_url) }}" required>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="url" name="iframe_url" id="iframe_url" class="form-control" 
                                                ...
                                                value="{{ old('iframe_url',$contact->iframe_url) }}" required>
                                        ...
                                        <div class="col-md-6 mt-5">
                                            ...
                                            <input class="form-control" id="associates_name" type="text" name="associates_name" value="{{ old('associates_name',$contact->associates_name) }}"  placeholder="Enter Associates Name" required>
                                        ...
                                        <div class="container mt-5">
                                            ...
                                            <table class="table table-bordered mt-3" id="instituteTable">
                                                ...
                                                <tbody>
                                                    ...
                                                    @if(!empty($contact->associates_details))

                                                        @foreach($contact->associates_details as $key => $associate)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <img src="{{ asset('uploads/contact/'.$associate['image']) }}" style="max-width:80px;margin-bottom:5px">
                                                                @endif
                                                            ...
                                                            <td>
                                                                ...
                                                                value="{{ $associate['institute_name'] ?? '' }}">
                                                            </td>

                                                            <td>
                                                                <input type="text" name="contact_no[]" class="form-control"
                                                                value="{{ $associate['contact_no'] ?? '' }}">
                                                            </td>
