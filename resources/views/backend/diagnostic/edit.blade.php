                                ...
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input"
                                        ...
                                        <div class="col-md-6 mt-5">
                                            ...
                                            <small class="text-secondary"><b>Note: The file size should be less than 2MB.</b></small><br>
                                            <small class="text-secondary">
                                                <b>Note: Only .jpg, .jpeg, .png, .webp, .svg allowed.</b>
                                            </small>

                                            <input type="hidden" name="removed_service_images" id="removed_service_images">

                                            <!-- Preview -->
                                            <div id="serviceimagePreview" class="d-flex flex-wrap mt-2">

                                                @if(!empty($service_details->service_image))
                                                    @foreach($service_details->service_image as $img)
                                                        ...
                                                        <div style="position:relative;margin:5px">
                                                            ...
                                                            <span onclick="removeExistingServiceImage('{{ $img }}',this)"
                                                                style="
                                                                    position:absolute;
                                                                    top:2px;
                                                                    right:6px;
