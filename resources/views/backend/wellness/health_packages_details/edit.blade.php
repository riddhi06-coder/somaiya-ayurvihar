        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Edit Health Packages Details Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit Health Packages Details</li>
                </ol>
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form action="{{ route('admin.manage-packages-details.update', $health_package_detail->id) }}"
                                        method="POST"
                                            ...
                                            <select class="form-select" name="package_id" id="package_id" required>
                                                ...
                                                @foreach($categories as $package)
                                                    <option value="{{ $package->id }}"
                                                        ...
                                                        {{ $health_package_detail->package_id == $package->id ? 'selected' : '' }}>
                                        ...
                                        <div class="col-md-6 mt-5">
                                            ...
                                            <select class="form-select" id="subcategory_select" disabled>
                                                <option value="">
                                                    {{ $health_package_detail->subcategory->subcategory_name ?? 'Select Category' }}
                                                </option>
                                            </select>

                                            <input type="hidden"
                                                name="sub_category_id"
                                                id="hidden_subcategory_id"
                                                value="{{ $health_package_detail->sub_category_id }}">
                                        </div>

                                        <!-- Location -->
                                        <div class="col-md-6 mt-5">
                                            <label class="form-label" for="location">Location <span class="text-danger">*</span> </label>
                                            <input class="form-control" id="location" type="text" name="location"  value="{{ old('location', $health_package_detail->location) }}" placeholder="Enter Location" required>
                                        ...
                                        <div class="col-md-6 mt-5">
                                            ...
                                            <input class="form-control" id="location_url" type="url" name="location_url" value="{{ old('location_url', $health_package_detail->location_url) }}" placeholder="Enter Location URL" required>
                                        ...
                                        <div class="col-md-12 mt-4">
                                            ...
                                            <textarea class="form-control"
                                                    ...
                                                    rows="4"
                                                    required
                                                    placeholder="Enter Description">{{ old('description', $health_package_detail->description) }}</textarea>
                                        </div>
