                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('admin.manage-virtual-tour.store') }}" method="POST" enctype="multipart/form-data" id="testimonialForm">
                                        @csrf
                                        ...
                                        <!-- Video (video only) -->
                                        <div class="col-md-6 mt-4 video-fields">
                                            <label class="form-label" for="video">Virtual Tour Video <span class="txt-danger">*</span></label>
