                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                @if($footer->logo)
                                    <img src="{{ asset('home/footer/' . $footer->logo) }}"
                                        alt="Logo"
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea name="address"
                                        class="form-control"
                                        rows="3"
                                        placeholder="Enter Address">{{ old('address', $footer->address) }}</textarea>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="map_iframe"
                                        class="form-control"
                                        rows="3"
                                        placeholder="<iframe ...></iframe>">{{ old('map_iframe', $footer->map_iframe) }}</textarea>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text"
                                    name="enquiry_number"
                                    class="form-control"
                                    value="{{ old('enquiry_number', $footer->enquiry_number) }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text"
                                    ...
                                    class="form-control"
                                    value="{{ old('emergency_contact', $footer->emergency_contact) }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text"
                                    ...
                                    class="form-control"
                                    value="{{ old('wellness_appointment', $footer->wellness_appointment) }}"
