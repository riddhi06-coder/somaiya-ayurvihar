                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body row g-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="map_iframe" class="form-control" rows="3" placeholder="<iframe ...></iframe>">{{ old('map_iframe') }}</textarea>
                            </div>

                            <div class="col-md-6">
                                <label class="form-label">24x7 Enquiry Number</label>
                                <input type="text" name="enquiry_number" class="form-control" value="{{ old('enquiry_number') }}">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="opd_appointment" class="form-control" value="{{ old('opd_appointment') }}">
                            </div>

                            <div class="col-md-6">
                                <label class="form-label">Wellness Appointment</label>
                                <input type="text" name="wellness_appointment" class="form-control" value="{{ old('wellness_appointment') }}">
                            </div>
                        ...
                        <div class="card-body">
                            <table class="table table-bordered" id="socialTable">
                                ...
                                <tbody>
                                    <tr class="social-row">
                                        <td>
                                            <input type="text" name="social_icon[0][icon]" class="form-control" placeholder="fa-facebook">
                                        </td>
                                        <td>
                                            <input type="url" name="social_icon[0][url]" class="form-control" placeholder="https://facebook.com">
                                        </td>
                                        <td>
