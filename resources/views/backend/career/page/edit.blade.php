...
<head>
    @include('components.backend.head')
        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Edit Career Page Details Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('admin.manage-career-page.update', $service_details->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="heading" type="text" name="heading" placeholder="Enter Heading"  value="{{ $service_details->heading }}" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            @if($service_details->banner_image)
                                                <div class="mt-2">
                                                    <img src="{{ asset('uploads/service-details/'.$service_details->banner_image) }}"
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" id="editor" name="desc" placeholder="Enter Description" required>  {{ $service_details->desc }}</textarea>
                                        ...
                                        <div class="col-md-6 mt-5">
                                            ...
                                            <input class="form-control" id="benefits_heading" type="text" name="benefits_heading" value="{{ $service_details->benefits_heading }}" placeholder="Enter Heading" required>
                                            <div class="invalid-feedback">Please enter a Heading.</div>
                                        </div>
                                        ...
                                        <div class="col-12 mt-5">
                                            ...
                                            <table class="table table-bordered" id="benefitsTable">
                                                ...
                                                <tbody>
                                                    @foreach($service_details->benefits as $index => $benefit)
                                                        <tr class="benefits-row">
                                                            <td>
                                                                <input type="text"
                                                                    name="benefits[{{ $index }}][question]"
                                                                    class="form-control"
                                                                    value="{{ $benefit['question'] }}">
                                                            </td>
                                                    
                                                            <td>
                                                                <textarea name="benefits[{{ $index }}][answer]"
                                                                    class="form-control benefits-editor"
                                                                    rows="3">{{ $benefit['answer'] }}</textarea>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <input type="file"
                                                                    ...
                                                                    class="form-control"
                                                                    accept="image/*"
                                                                    onchange="previewbenefitsImage(event, {{ $index }})">
                                                    
                                                                <!-- Old Image -->
                                                                @if(!empty($benefit['image']))
                                                                    <div class="mt-2">
                                                                        <img src="{{ asset('uploads/service-details/'.$benefit['image']) }}"
                                                                            id="benefitsPreview_{{ $index }}"
                                                                            style="max-width:100px; border-radius:6px; border:1px solid #ddd;">
                                                                    </div>
                                                                @else
                                                                    <img id="benefitsPreview_{{ $index }}"
                                        ...
                                        <div class="col-md-6 mt-5">
                                            ...
                                            <input class="form-control" id="job_heading" type="text" name="job_heading" value="{{ $service_details->job_heading }}" placeholder="Enter Job Opening Heading" required>
       ...
       @include('components.backend.main-js')
        ...
        <script>
            let benefitsIndex = {{ count($service_details->benefits) }};
