        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Edit Billing Process Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit Billing Process</li>
                </ol>
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                   <form class="row g-3 needs-validation custom-input"
                                          novalidate
                                          action="{{ route('admin.manage-billing-process.update', $billing->id) }}"
                                          method="POST"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="visitor_heading" type="text"  value="{{ $billing->visitor_heading }}" name="visitor_heading" placeholder="Enter Visitors Heading" required>
                                        ...
                                        <div class="col-12">
                                            <table class="table table-bordered mt-5" id="pageHeadersTable">
                                                ...
                                                <tbody>
                                                    ...
                                                    @php
                                                        $visitorDetails = is_array($billing->visitor_details) 
                                                            ? $billing->visitor_details 
                                                            : json_decode($billing->visitor_details, true);
                                                    @endphp
                                                    
                                                    @foreach($visitorDetails ?? [[]] as $index => $item)
                                                    <tr>
                                                        <td>
                                                            <input type="file" name="visitor_details[{{ $index }}][image]" class="form-control header-image">
                                                            ...
                                                            @if(!empty($item['image']))
                                                                <img src="{{ asset('uploads/visitors/'.$item['image']) }}" 
                                                        ...
                                                        <td>
                                                            <input type="text" name="visitor_details[{{ $index }}][heading]" 
                                                                   class="form-control" value="{{ $item['heading'] ?? '' }}">
                                                        </td>
                                                    
                                                        <td>
                                                            <textarea name="visitor_details[{{ $index }}][time]" 
                                                                      class="form-control">{{ $item['time'] ?? '' }}</textarea>
                                                        </td>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="room_heading"  value="{{ $billing->room_heading }}" type="text" name="room_heading" placeholder="Enter Heading" required>
                                        ...
                                        <div class="col-12">
                                            <table class="table table-bordered mt-5" id="roomTypeTable">
                                                ...
                                                <tbody>
                                                    @php
                                                        $roomTypes = is_array($billing->room_types) 
                                                            ? $billing->room_types 
                                                            : json_decode($billing->room_types, true);
                                                    @endphp
                                                    
                                                    @foreach($roomTypes ?? [[]] as $index => $item)
                                                    <tr>
                                                        <td>
                                                            <input type="file" name="room_types[{{ $index }}][image]" class="form-control">
                                                            <small class="text-secondary"><b>Note: The file size should be less than 2MB.</b></small>
                                                            <br>
                                                            <small class="text-secondary"><b>Note: Only files in .jpg, .jpeg, .png, .webp, .svg format can be uploaded.</b></small>
                                                            ...
                                                            @if(!empty($item['image']))
                                                                <img src="{{ asset('uploads/rooms/'.$item['image']) }}" 
                                                                     class="room-preview mt-2" 
                                                                     style="max-height:80px;">
                                                            @endif
                                                        </td>
                                                    
                                                        <td>
                                                            <input type="text" name="room_types[{{ $index }}][heading]" 
                                                                   class="form-control" value="{{ $item['heading'] ?? '' }}">
                                                        </td>
                                        ...
                                        <div class="col-md-6 mt-5">
                                            ...
                                            <input class="form-control" id="room_rent_heading" type="text" name="room_rent_heading" value="{{ $billing->room_rent_heading }}" placeholder="Enter Heading" required>
                                            <div class="invalid-feedback">Please enter a Heading.</div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" id="editor" name="room_rent_desc" placeholder="Enter Description" required>{{ $billing->room_rent_desc }}</textarea>
                                        ...
                                        <div class="col-md-6 mt-5">
                                            ...
                                            <input class="form-control" id="general_info_heading" type="text" name="general_info_heading" value="{{ $billing->general_info_heading }}" placeholder="Enter Heading" required>
                                            <div class="invalid-feedback">Please enter a Heading.</div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" id="general_info_desc" name="general_info_desc" placeholder="Enter Description" required>{{ $billing->general_info_desc }}"</textarea>
                                            <div class="invalid-feedback">Please enter an Description.</div>
                                        </div>
                                        ...
                                        <div class="col-md-6 mt-5">
                                            ...
                                            <input class="form-control" id="doc_sub_heading" type="text" name="doc_sub_heading" value="{{ $billing->doc_sub_heading }}" placeholder="Enter Heading" required>
                                            <div class="invalid-feedback">Please enter a Heading.</div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <table class="table table-bordered mt-3" id="documentTimelineTable">
                                                ...
                                                <tbody>
                                                    @php
                                                        $docTimelines = is_array($billing->document_timelines) 
                                                            ? $billing->document_timelines 
                                                            : json_decode($billing->document_timelines, true);
                                                    @endphp
                                                    
                                                    @foreach($docTimelines ?? [[]] as $index => $item)
                                                    <tr>
                                                        <td>
                                                            <input type="file" name="document_timelines[{{ $index }}][image]" class="form-control">
                                                            <small class="text-secondary"><b>Note: The file size should be less than 2MB.</b></small>
                                                            <br>
                                                            <small class="text-secondary"><b>Note: Only files in .jpg, .jpeg, .png, .webp, .svg format can be uploaded.</b></small>
                                            
                                                            @if(!empty($item['image']))
                                                                <img src="{{ asset('uploads/document_timelines/'.$item['image']) }}" 
                                                                     class="doc-preview mt-2" 
                                                                     style="max-height:80px;">
                                                            @endif
                                                        </td>
                                                    
                                                        <td>
                                                            <input type="text" name="document_timelines[{{ $index }}][heading]" 
                                                                   class="form-control" value="{{ $item['heading'] ?? '' }}">
                                                        </td>
                                                    
                                                        <td>
                                                            <textarea name="document_timelines[{{ $index }}][time]" 
                                                                      class="form-control">{{ $item['time'] ?? '' }}</textarea>
                                                        </td>
                                        ...
                                        <div class="col-md-6 mt-5">
                                            ...
                                            <input class="form-control" id="doc_submitted_heading" type="text" name="doc_submitted_heading" value="{{ $billing->doc_submitted_heading }}" placeholder="Enter Heading" required>
                                            <div class="invalid-feedback">Please enter a Heading.</div>
                                        </div>
                                       ...
                                       <!--  Image -->
                                        <div class="col-md-6 mt-5">
                                            ...
                                            @if($billing->doc_image)
                                                <img src="{{ asset('uploads/documents/'.$billing->doc_image) }}" 
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" id="doc_submitted_desc" name="doc_submitted_desc" placeholder="Enter Description" required>{{ $billing->doc_submitted_desc }}</textarea>
                                            <div class="invalid-feedback">Please enter an Description.</div>
                                        </div>
                                        ...
                                        <div class="col-md-12 mb-2">
                                            ...
                                            <input type="text" class="form-control" id="sd_heading" name="sd_heading" placeholder="Enter Heading" value="{{ $billing->sd_heading }}">
                                        </div>
                                         <!-- Description-->
                                        <div class="col-md-12">
                                            <label class="form-label" for="sd_desc"> Security Deposit Description</label>
                                            <textarea class="form-control" id="sd_desc" name="sd_desc" placeholder="Enter Description">{{ $billing->sd_desc }}</textarea>
                                            <div class="invalid-feedback">Please enter an Description.</div>
                                        </div>
                                        ...
                                        <div class="col-md-12 mb-2">
                                            ...
                                            <input type="text" class="form-control" id="declaration_heading" name="declaration_heading" placeholder="Enter Heading" value="{{ $billing->declaration_heading }}">
                                        </div>
                                         <!-- Description-->
                                        <div class="col-md-12">
                                            <label class="form-label" for="declaration_desc"> Declarations Description</label>
                                            <textarea class="form-control" id="declaration_desc" name="declaration_desc" placeholder="Enter Description">{{ $billing->declaration_desc }}</textarea>
                                            <div class="invalid-feedback">Please enter an Description.</div>
                                        </div>
       ...
       @include('components.backend.main-js')
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                let roomIndex = document.querySelectorAll('#roomTypeTable tbody tr').length;
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                let headerIndex = document.querySelectorAll('#pageHeadersTable tbody tr').length;
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                let docIndex = document.querySelectorAll('#documentTimelineTable tbody tr').length;
